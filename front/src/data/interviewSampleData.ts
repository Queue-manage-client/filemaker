...
export const interviewSampleData: InterviewRecord[] = [
  {
    ...
    location: "本店 面接ルームA",
    notes: "明るい性格、接客経験あり",
    surveyContent: "接客経験あり。週3〜4日希望。深夜可。",
  ...
  },
  {
    ...
    surveyContent: "VIP接客経験3年。英語対応可。週5日フルタイム希望。",
  ...
  },
  {
    ...
    surveyContent: "未経験。接客業志望。週2〜3日希望。出稼ぎ期間1ヶ月予定。",
  ...
  },
  {
    ...
    notes: "接客マナー研修受講経験あり",
    surveyContent: "接客マナー研修修了。土日祝出勤可。扶養内勤務希望。",
